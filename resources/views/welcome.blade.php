          ...
          <div class="col"><a href="" style="float: right;text-decoration:none;">Todas as matérias</a></div>
			...
			<div style="margin-top: 10px;margin-bottom:10px;" class="col-6 col-md-4"> 
				...
				<div class="row" style="margin-left: 15px;">
					<div class="col-2">
						<div class="row alert alert-primary" style="background-color:#26614a; padding:10px;color:white;text-align:center;">
							<h3> 6</h3> de agosto
						</div>	
					</div>
					<div class="col" style="margin-left:20px;margin-top:5px;">
						<div class="row">Envie uma mensagem de SOS<br>
			...
			<div class="container" style="margin-top: 15px;">
				<div class="row">
					...
					<div class="col" style="text-align: center">
						<div class="row" style="vertical-align: middle; transform: translate(100px, 0px);"> <img src="{{asset('img/1233.png')}}" style="vertical-align: middle" height="60px;"> </div>
						<br>
						<div class="row">
